...
using JhipsterBlazor.Shared.Components;
...
namespace JhipsterBlazor.Test
{
    public class AlertErrorTest : TestContext
    {
        ...
        [Fact]
        public async void Should_DisplayNotReach_When_NotReach()
        {
        ...
        [Fact]
        public async void Should_DisplayErrorHeader_When_Error()
        {
            HttpResponseMessage response = new HttpResponseMessage
            {
        ...
        [Fact]
        public async void Should_NotAddError_When_BadRequest_Without_ErrorHeader()
        {
            HttpResponseMessage response = new HttpResponseMessage
            {
                StatusCode = HttpStatusCode.BadRequest,
